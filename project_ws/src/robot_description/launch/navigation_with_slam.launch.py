...
def generate_launch_description():
    ...
    gazebo_models_path, ignore_last_dir = os.path.split(robot_description)
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([robot_description, 'rviz', LaunchConfiguration('rviz_config')])],
